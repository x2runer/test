-- TRUEDEX V2 - Full UI Library (Fixed Version 2026 + Conversion Mode)
-- Tab hiển thị đúng + Search hoạt động tốt + Chuyển đổi bằng biến conversion
...
-- ==================== CONVERSION MODE ====================
-- Bạn thay đổi ở đây để chuyển GUI
local conversion = "main"   -- "main" hoặc "kaitun"
...
function TRUEDEXV2:CreateWindow(config)
    ...
    -- Switch GUI Button (hiển thị conversion hiện tại)
    local SwitchBtn = Instance.new("TextButton")
    SwitchBtn.Size = UDim2.new(0, 110, 0, 24)
    SwitchBtn.Position = UDim2.new(1, -170, 0, 2)
    SwitchBtn.BackgroundColor3 = TRUEDEXV2.THEME.ACCENT
    SwitchBtn.BackgroundTransparency = 0.3
    SwitchBtn.Text = conversion == "main" and "→ KAITUN" or "→ MAIN"
    ...
    -- ==================== GUI PHỤ - KAITUN ====================
    -- ==================== BẠN VIẾT CODE GUI KAITUN Ở ĐÂY ====================
    ...
    local SubBackground = Instance.new("ImageLabel")
    SubBackground.Size = UDim2.new(1, 0, 1, 0)
    SubBackground.BackgroundTransparency = 1
    SubBackground.Image = bgImageId
    SubBackground.ImageTransparency = 0.7
    SubBackground.ScaleType = Enum.ScaleType.Crop
    SubBackground.ZIndex = 0
    SubBackground.Parent = SubContent

    -- ====================== ĐẶT CODE GUI KAITUN CỦA BẠN VÀO ĐÂY ======================
    -- Ví dụ:
    -- local KaitunLabel = Instance.new("TextLabel")
    -- KaitunLabel.Text = "Kaitun GUI - Đang phát triển..."
    -- KaitunLabel.Size = UDim2.new(1, 0, 0, 50)
    -- KaitunLabel.Position = UDim2.new(0, 0, 0.4, 0)
    -- KaitunLabel.BackgroundTransparency = 1
    -- KaitunLabel.TextColor3 = TRUEDEXV2.THEME.TEXT
    -- KaitunLabel.Font = Enum.Font.GothamBold
    -- KaitunLabel.TextSize = 18
    -- KaitunLabel.Parent = SubContent
